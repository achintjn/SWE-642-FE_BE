...
public class LoginUserInfoUserDetails implements UserDetails {
	...
	public LoginUserInfoUserDetails(LoginUsersInfo loginUser){
		name = loginUser.getName();
		password = loginUser.getPassword();
		authorities = Arrays.stream(loginUser.getRoles().split(",")).map(SimpleGrantedAuthority::new).collect(Collectors.toList());
